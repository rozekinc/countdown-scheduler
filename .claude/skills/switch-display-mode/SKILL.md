...
`data/display.json`. This is a property of the room's lighting, not of app branding
...
- `data/display.json` — the current `displayModeId`.

## Edit

In `data/display.json`, set `displayModeId` to the chosen mode id. For `standard`
