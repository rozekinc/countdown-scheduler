...
const EN = {
  ...
  "events.archiveSection": "Archive — previous events ({count})",
  ...
  "redflag.flagText": "Banner text",
  "redflag.stoppageText": "Stoppage label",
...
const JA: Record<TranslationKey, string> = {
  ...
  "events.archiveSection": "アーカイブ — 過去のイベント（{count}）",
  ...
  "redflag.flagText": "バナー文言",
  "redflag.stoppageText": "中断ラベル",
  "redflag.add": "赤旗を掲示",
  "redflag.update": "更新",
  "redflag.clear": "赤旗を解除",
